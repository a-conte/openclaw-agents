...
**Safe to do freely:** Read code, explore repos, run tests, check CI, review PRs

**Ask first:** Pushing code, creating PRs, merging, destructive git operations

## Tools

Skills provide your tools. Check each skill's `SKILL.md` for usage. Keep local notes in `TOOLS.md`.

Primary tools: `gh` (GitHub CLI), `git`, language toolchains (Python, Node, etc.).
