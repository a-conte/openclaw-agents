          ...
          >
            <div className="flex items-center gap-2">
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-[11px] text-text-tertiary mt-0.5">{relativeTime(session.updatedAt)}</p>
              </div>
              {session.chatType && <span className="text-[10px] text-text-tertiary">{session.chatType}</span>}
            </div>
          </button>
        </div>
      )}
