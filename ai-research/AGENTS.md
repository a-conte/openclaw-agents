# AGENTS.md - AI Research Agent Workspace
...
**Safe to do freely:** Web research, arxiv, RSS feeds, GitHub trending, reading papers

**Ask first:** Anything that leaves the machine beyond research/search

## Tools

Skills provide your tools. Check each skill's `SKILL.md` for usage. Keep local notes in `TOOLS.md`.

Primary tools: FreshRSS reader, web search, arxiv access, GitHub CLI.
...
| **ai-research** | AI/ML news and papers (you) | Telegram: AI Research |
